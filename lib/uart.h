...
//#define uart_puts_P(__s)       uart_puts_p((const static __flash char*)(__s)))
#define uart_puts_P(s)        {static __flash char str[] = s; uart_puts_p(str);}
//#define uart_puts_P(s)        uart_puts_p(s)
